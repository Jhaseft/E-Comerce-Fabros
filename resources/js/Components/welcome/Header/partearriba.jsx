export default function ParteArriba() {
  const socialLinks = [
    {
      name: 'Tiktok',
      ...
      icon: (
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          <path d="M12.75 2h2.5c.2 1.7 1.4 3.2 3.1 3.8.7.3 1.4.4 2.2.4v2.6c-.9 0-1.8-.2-2.7-.5-.7-.3-1.4-.7-2-1.2v7.1c0 3.6-2.9 6.5-6.5 6.5S3 17.8 3 14.2s2.9-6.5 6.5-6.5c.3 0 .7 0 1 .1v2.7c-.3-.1-.7-.2-1-.2-2 0-3.7 1.6-3.7 3.7S7.5 17.7 9.5 17.7s3.7-1.6 3.7-3.7V2z" />
        </svg>
      ),
    },
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/FabrosBolivia',
      icon: (
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex items-center gap-1">
            ...
            {socialLinks.map((social) => (
              ...
              >
                ...
                <span className="absolute -bottom-8 left-1/2 -translate-x-1/2 bg-white text-black text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap pointer-events-none">
                  {social.name}
                </span>
              </a>
            ))}
