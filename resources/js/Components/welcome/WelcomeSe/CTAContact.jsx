        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="flex justify-center">
            <div className="relative">
              <div className="absolute inset-0 bg-brandBlue blur-2xl opacity-30 animate-pulse"></div>
              <div className="relative bg-brandBlue p-6 rounded-3xl shadow-2xl">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-brandBlue leading-tight">
            ...
            <span className="relative inline-block">
              ...
              <svg className="absolute -bottom-2 left-0 w-full" height="12" viewBox="0 0 300 12" fill="none">
                <path d="M2 10C50 2 250 2 298 10" stroke="#9ab7ca" strokeWidth="3" strokeLinecap="round" />
              </svg>
            </span>
            ?
          </h2>
          ...
          <div className="pt-8 flex flex-wrap justify-center gap-8 text-gray-600">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-full bg-brandBlue flex items-center justify-center shadow-lg">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                ...
                <div className="text-lg font-bold text-brandBlue">info@fabros.com.bo</div>
              </div>
            </div>
          </div>
        </div>
